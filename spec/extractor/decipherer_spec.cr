...
describe Youtube::Decipherer do
  describe "#decrypt" do
    it "should decrypted signature" do
      ...
      Youtube::Decipherer.new(url).decrypt(encrypted_sig).should eq decrypted_sig
    end
    ...
    it "have correct decoder steps" do
      ...
      decipher = Youtube::Decipherer.new(url)
  ...
  describe "#package" do
    it "encoded urls" do
      ...
      Youtube::Decipherer.new(url).package(encoded_urls).should eq rtn
    end
  end
end
